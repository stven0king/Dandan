...
public final class Timber {
    ...
    public static abstract class Tree {
         ...
         * @param message Formatted log message. May be {@code null}, but then {@code t} will not
         * be.
         * @param t Accompanying exceptions. May be {@code null}, but then {@code message} will not
         * be.
         */
